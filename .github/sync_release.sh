...
UPSTREAM_REPO="https://github.com/MiSTer-devel/SVI328_MiSTer.git"
CORE_NAME=(Svi328)
...
UPSTREAM_CORE_NAME=(Svi328)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(SVI328.qpf)
COMPILATION_OUTPUT=(output_files/SVI328.rbf)
